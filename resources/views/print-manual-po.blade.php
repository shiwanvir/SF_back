...
<div class="container" id="mainDiv">
    <div class="row" style="width:100%;">
        <div style="float:left; width:40%;">
            <h3 style="font-weight:bold; text-align:left;">Manual Purchase Order</h3>
        </div>
        <div style="float:left;width:40%;">
            <div id="example2">
                ...
                <div>E-Mail: b@helaclothing.com Web: www.fdnsl.com</div>
            </div>
        </div>
    ...
    <div class="row" style="margin-top:3px;">
        <table width="100%" align="center" border="1" id="list_tbl">
            <tr>
                <td align="center"><strong>Line No</strong></td>
                @if($po_inv_type == 'INVENTORY')
                <td align="center"><strong>Item Code</strong></td>
                <td align="center"><strong>Item Description</strong></td>
                @else
                <td align="center"><strong>Material Description</strong></td>
                @endif
            ...
            <tr>
                ...
                <td align="center">{{ $d->required_date}}</td>
                @if($d->purchase_uom_code == null)
                <td align="center">{{ $d->uom }}</td>
                @else
                <td align="center">{{ $d->purchase_uom_code }}</td>
                @endif
                {{ $val = ($d->qty * $d->purchase_price) }}
                <td align="right">{{ number_format($d->purchase_price,4) }}</td>
                <td align="right">{{ number_format($d->qty,4) }}</td>
                <td align="right">{{ number_format($val,4) }}</td>
            </tr>
            {{ $tot_qty += $d->qty }}
            {{ $tot_val += $val }}
            @endforeach
            <tr>
                ...
                <td align="right"><strong>{{ number_format($tot_qty,4) }}</strong></td>
                <td align="right"><strong>{{ number_format($tot_val,4) }}</strong></td>
            </tr>
        </table>
    </div>
    ...
    <div class="row" style="margin-top:2px;">
        ...
        <h6 style="font-weight:bold; text-align:left;">Manual Purchase Order Summary</h6>
    </div>
    ...
    <div class="row">
        ...
        <table width="100%" align="center" border="1" id="list_tbl">
            <tr>
                ...
                <td align="center"><strong>Delivery Date</strong></td>
                <td align="center"><strong>UOM</strong></td>
                <td align="right"><strong>Purchase Price ( {{ $currency }} )</strong></td>
                <td align="center"><strong>Qty</strong></td>
            </tr>
            {{ $t_qty = 0 }}
            {{ $colspan = 5 }}
            ...
            <tr>
                ...
                <td align="center">{{ $item->req_date }}</td>
                @if($item->purchase_uom_code == null)
                <td align="center">{{ $item->uom }}</td>
                @else
                <td align="center">{{ $item->purchase_uom_code }}</td>
                @endif
                <td align="right">{{ number_format($item->purchase_price,4) }}</td>
                <td align="right">{{ number_format($item->qty,4) }}</td>
            </tr>
            {{ $t_qty += $item->qty }}
            @endforeach
            <tr>
                <td colspan="{{ $colspan }}" align="center"></td>
                <td align="right"><strong>{{ number_format($t_qty,4) }}</strong></td>
            </tr>
        </table>
    </div>

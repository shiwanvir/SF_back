            ...
            <tr>
              <td class="bodycopy">
                <p> Dear {{ $user_name }},
                  <br>
                  <br>
                      The Consumption has been added to all Main Materials for Style No - {{ $costing->style_no }} by {{ $cad_user }}.
                  </p>
                      ...
                      <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button" height="45">
                            <a href="{{config('surface.surface_path')}}/merchandising/cost-sheet">Click Here </a><br>
                            <a href="{{config('surface.surface_path')}}/merchandising/cost-sheet" style="font-size:9px;">(To view Costing)</a>
                          </td>
                        </tr>
                      </table>
                    </td>

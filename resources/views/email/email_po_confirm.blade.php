                        ...
                        <tr>
                          <td class="bodycopy">
                            <p> Hi All,
                              <br>
                              <br>
                                Purchase Order No – {{ $po->po_number }} has been released by {{ $po->user_name }}. Please review the summary details below.
                            </p>
                            <table class="table table-striped" width="100%" border="1">
                                ...
                                @foreach($po_lines as $line)
                    				    <tr>
                    				      <td>{{ $line->line_no }}</td>
                                  <td>{{ $line->master_code }}</td>
                                  <td>{{ $line->master_description }}</td>
                                  <td>{{ $line->color_code }}</td>
                                  <td>{{ $line->deli_date }}</td>
                                  <td>{{ $line->uom_code }}</td>

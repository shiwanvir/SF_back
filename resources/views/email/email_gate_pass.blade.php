            ...
            <tr>
              <td class="bodycopy">
                <p> Dear {{ $mail_user_login->user_name }},
                  <br>
                  <br>
                  Please find below the  Gate Pass for style - {{ $costing->style_id }}, of {{ $customer->customer_name }}, for your approval, sent by {{ $merchant->user_name }}   <br>
                  <br>
                  <b>Please Review:</b>
              ...
              <table class="table table-borderless" width="100%" border="0" cellspacing="0" cellpadding="0">
      					  ...
      					  <tr>
      					    <th width="24%" align="left">Gate Pass NO</th>
      					    <th width="2%">:</th>
      					    <td width="24%">{{$costing->epm}}</td>
                  </tr>
                  <tr>
                    <th width="40%" align="left">Transfer Location </th>
                    <th width="2%">:</th>
                    <td width="24%">{{$costing->np_margine}}</td>
                  </tr>
                  <tr>
      					    <th width="24%" align="left">Receiver Location</th>
      					    <th width="2%">:</th>

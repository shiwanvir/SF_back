          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="bodycopy">
                ...
                <thead>
                <tr>
              <th width="24%" align="left">Machine Type Code</th>
             <th width="24%" align="left">Machine Type Name</th>
            </tr>
          </thead>
           <tbody>
              <tr>
              <td width="24%" align="center">{{ $machine_type->machine_type_code }}</td>
              <td width="24%" align="center">{{ $machine_type->machine_type_name }}</td>
              </tr>

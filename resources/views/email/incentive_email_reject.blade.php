          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                ...
                ?>
                Incentive Approval REJECTED - {{ $final_incentive->email_id }}
              </td>
            </tr>
            <tr>
              <td class="h6">
                Dear Sir/Madam,<br/><br/>
                The production incentive amount from {{$first}} to {{$last}} has been REJECTED and send for payroll.<br/>
                For a Full report of the production incentive,Please Click <a href="#" >Here</a>.<br/><br/>
                Thank You.
              </td>
            </tr>

            ...
            <tr>
              <td class="bodycopy">
                <p> Dear {{ $mail_user_login->user_name }},
                  <br>
                  <br>
                  Please find below code {{ $machine_type->machine_type_code }} with the name of {{ $machine_type->machine_type_name }}, for your approval, sent by {{ $created_by->user_name }}   <br>
                  <b>Please Review:</b>
                  </p>

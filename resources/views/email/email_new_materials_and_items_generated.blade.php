      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="h2"> <u>
                New Materials & Items Generated  </u>
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                <p> Dear All,
                  <br>
                  <br>
                  100 new items have been created.
                  Kindly review the data accuracy and the item price.
                  <br>
                  In case there is a discrepancy, kindly e-mail the correct detail to the responsible merchandiser.
                </p>

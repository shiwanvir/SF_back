      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy">
                <p> Dear {{ $style->user_name }},
                  <br>
                  <br>
                      The SMV - Version {{ $smv->revision_no }} for Style No - {{ $style->style_no }}
                      has been updated by {{ $smv->user_name }}.
                  </p>
      <tr>
        <td class="innerpadding borderbottom">
                      ...
                      <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button" height="45">
                            ...
                            <a href="{{config('surface.surface_path')}}/ie/component-smv" style="font-size:9px;" >( To View SMV )</a>
                          </td>
                        </tr>
                      </table>
                    </td>

      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="h2"> <u>
                Operation Component for Review </u>
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                <p> Dear {{ $mail_user_login->user_name }},
                  <br>
                  <br>
                  Please find below code {{ $operation_component->operation_component_code }} with the name of {{ $operation_component->operation_component_name }}, for your approval, sent by {{ $created_by->user_name }}   <br>
                  <br>
                  <b>Please Review:</b>
                  </p>

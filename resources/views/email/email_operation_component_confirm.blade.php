      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2"> <u>
                Operation Component Approved
              </td>
            </tr>

              <tr>
              <td class="bodycopy">
                <p>Dear {{ $created_user_name }},</p>
                <table class="table table-striped" width="100%" style="text-align:center" border="1">
                <thead>
                <tr>
              <th width="24%" align="left">Operation Component Code</th>
             <th width="24%" align="left">Operation Component Name</th>
            </tr>
          </thead>
           <tbody>
              <tr>
              <td width="24%" align="center">{{ $operation_component->operation_component_code }}</td>
              <td width="24%" align="center">{{ $operation_component->operation_component_name }}</td>
              </tr>

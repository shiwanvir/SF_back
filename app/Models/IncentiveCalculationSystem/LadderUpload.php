...
class LadderUpload extends BaseValidator
{
    protected $table = 'inc_efficiency_ladder';
    ...
    **/
    protected function getValidationRules($data) {
      return [
        'order_type' => [
          'required',
          'unique:inc_efficiency_ladder,order_type,'.$data['inc_efficiency_ladder_id'].',inc_efficiency_ladder_id',
        ],
          'qco_date' => 'required',

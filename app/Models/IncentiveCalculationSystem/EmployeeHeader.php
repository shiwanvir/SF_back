...
class EmployeeHeader extends BaseValidator
{
    protected $table = 'inc_employee_header';
    protected $primaryKey = 'emp_header_id';
    ...
    protected function getValidationRules($data) {
      return [
        'production_incentive_header_id' => [
          'required',
          'unique:inc_employee_header,production_incentive_header_id,'.$data['emp_header_id'].',emp_header_id',
        ],
